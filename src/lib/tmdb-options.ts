...
export function movieToOption(movie: { id: number; title: string; releaseDate?: string }): SelectionOption {
...
export function personToOption(person: { id: number; name: string }): SelectionOption {
  return {
...
export function generateStaticOptions(type: 'genre' | 'yearRange', count: number): SelectionOption[] {
